        ...
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    <a href="{{route('lesson.index',['course_id' => $course_id])}}" class="btn btn-outline-primary mt-1 mb-4"><i class="ti ti-arrow-left"></i> Назад</a>
                    <h2 class="h4 card-header-title">Занятие</h2>
                </header>
                <div class="card-body pt-0">
                    <form action="{{route('lesson.store',['course_id' => $course_id])}}" method="post" enctype="multipart/form-data">
