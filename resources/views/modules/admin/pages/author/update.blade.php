        ...
        <div class="col-md-12 mb-5">
            <div class="card h-100">
                <header class="card-header">
                    <a href="{{route('author.index')}}" class="btn btn-outline-primary mt-1 mb-4">
                        <i class="ti ti-arrow-left"></i> Назад
                    </a>
                </header>
                @if($author)
                    <div class="card-header  border-dark">
                        <img src="{{asset($author->image_path)}}" style="max-height: 500px; max-width: 500px"
                             alt="author image" onerror="this.src='{{asset('images/notfound.png')}}'">
                    </div>
