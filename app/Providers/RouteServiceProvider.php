...
//        $this->mapWebVersionedRoutes(1);
        $this->mapAdminWebVersionedRoutes(1);
        $this->mapFrontWebVersionedRoutes(1);
...
//    }
    ...
    protected function mapFrontWebVersionedRoutes($version)
    {
        Route::middleware('web')
            ->namespace($this->getWebNamespace($version))
            ->group(base_path("routes/web/V$version/front.php"));
    }
