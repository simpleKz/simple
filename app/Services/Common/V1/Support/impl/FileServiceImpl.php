...
class FileServiceImpl extends BaseService implements FileService
{
    ...
    public function storeMaterial(UploadedFile $material, string $path): string
    {
        $material_path = $material->getClientOriginalName();
        $materialFullPath = $material->move($path, $material_path);
